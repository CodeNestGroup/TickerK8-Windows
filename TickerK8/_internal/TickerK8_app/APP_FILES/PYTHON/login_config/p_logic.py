...
def ResetConfig(self):
    with open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'r', encoding='utf-8') as file:
        c = json.load(file)
        c['language'] = 0
        c['theme'] = "vintage_elegance_dark"
        c['subscription'] = 0
        with open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'w', encoding='utf-8') as f:
