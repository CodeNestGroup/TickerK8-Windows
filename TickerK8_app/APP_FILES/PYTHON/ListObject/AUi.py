...
def ListObjectReloadStyle(self):
    m = open(f'{self.Path}/TickerK8_app/APP_FILES/PYTHON/ListObject/BMain.css', encoding='utf-8').read()
    c = open(f'{self.Path}/TickerK8_app/APP_FILES/PYTHON/ListObject/B{self.Theme}.css', encoding='utf-8').read()
...
def NullDataRetranslate(self):
    t = json.load(open(f'{self.Path}/TickerK8_app/APP_FILES/APP_FILES/PYTHON/ListObject/CNullDataRetranslate.json', 'r', encoding='utf-8'))
    l = self.Language
