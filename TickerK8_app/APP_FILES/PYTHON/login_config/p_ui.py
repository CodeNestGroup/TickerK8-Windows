...
def reload_style(self):
    self.setStyleSheet(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/c_style.css')
    # Dodać ikony

def retranslate(self):
    t = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_translate.json', 'r', encoding='utf-8'))
    l = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'r', encoding='utf-8'))['language']
...
def app_conf_retranslate(self):
    t = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_app_conf_translate.json', 'r', encoding='utf-8'))
    l = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'r', encoding='utf-8'))['language']
...
def sub_conf_reload_style(self):
    s = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'r'))['subscription']
...
def sub_conf_retranslate(self):
    t = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_sub_translate.json', 'r', encoding='utf-8'))
    l = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'r', encoding='utf-8'))['language']
    self.left_button.setText(t['left_button'][l])
...
def accept_settings_retranslate(self):
    t = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_accept_settings_translate.json', 'r', encoding='utf-8'))
    l = json.load(open(self.main_path+'/TickerK8_app/APP_FILES/PYTHON/login_config/j_config.json', 'r', encoding='utf-8'))['language']
