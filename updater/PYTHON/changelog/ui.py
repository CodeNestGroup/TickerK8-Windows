...
def changelog_reload_style(self):
    ...
    t = g['theme']
    self.setStyleSheet(open(str(self.main_path+'/updater/STYLE/CSS/changelog/'+t+'.css')).read())
    self.exit_button.setIcon(QIcon(load_svg(str(self.main_path+'/updater/STYLE/IMG/icons/changelog/exit_vintage_elegance_d.svg'), 256, 256)))

def changelog_retranslate(self):
    t = json.load(open(self.main_path+'/updater/CONFIG/changelog/translate.json', 'r', encoding='utf-8'))
