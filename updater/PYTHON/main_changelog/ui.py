...
def changelog_reload_style(self):
    ...
    t = g['theme']
    self.setStyleSheet(open(str(self.main_path+'/updater/STYLE/CSS/main_changelog/'+t+'.css')).read())
#______________________________________________________________________________________________________________________
...
def no_connection_reload_style(self):
    t = json.load(open(self.main_path+'/updater/CONFIG/GLOBAL/global_config.json', 'r', encoding='utf-8'))['theme']
    self.icon_label.setPixmap(load_svg(str(self.main_path+'/updater/STYLE/IMG/icons/main_changelog/no_connection_'+t+'.svg'), 256, 256))

def no_connection_retranslate(self):
    t = json.load(open(self.main_path+'/updater/CONFIG/main_changelog/translate.json', 'r', encoding='utf-8'))
